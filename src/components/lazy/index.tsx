...
export const Sidebar = lazy(() => import("@/components/common/Sidebar"));
export const BackToTop = lazy(() => import("@/components/common/BackToTop"));
...
export const LazyUpcomingTVShows = lazy(() => import("@/components/sections/UpcomingTVShows"));
